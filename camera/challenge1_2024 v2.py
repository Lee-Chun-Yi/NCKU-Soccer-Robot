...
SAFE_DIST = 13  # RoboRad/2 + ball radius
...
def Initialize():
    ...
    global stage,job,Robot,runaway,count_2,count_3,fix_problem
    stage = 1
    job = 2
    fix_problem = 4
    Robot = ['N1','N1','N1']
...
def strategy():
    ...
    global stage
    global job
    global Robot,kick_goal,fix_problem,count,runaway,count_2,count_3,count_4,goal
    Robot = ['N1','N1','N1']
    block = []
